...
### Раздел GENERAL
- mode - режим работы робора: 0 - тестирование алгоритма на исторических свечах, 2 - реальная интрадей торговля. (1 - режим торговли SandBox будет реализован в будущем)
### Раздел INVEST_API
...
Указываем детальные настройки алгоритма. Список настроек не типизирован и можент меняться от алгоритма (поле STRATEGY_NAME)
...
В режиме тестирования алгоритма происходит тестирование алгоритма по настрокам из раздела TEST_STRATEGY и TEST_STRATEGY_SETTINGS.
...
- Считывается расписание торгов и выбирается время начала торгов (начало основной сесии)
...
Расписание торгов:
- Робот взаимодействует с раписанием торгов
...
- Создать конфигурацию в settings.ini указав "имя класса" в поле name
- Для гибкости, настройки алгоритма не типизируемы и разбираются из dict в самом классе.
...
Уровень логирования и другие настройки при необходимости можyно поменять в main.py
